if (function(t, e) {
    ...
    var t = parseInt($(this).closest('.b-product__qty').find(".js-qty-input").attr("value"));
    t += 1, $(this).closest('.b-product__qty').find(".js-qty-input").attr("value", t).change(), $(this).closest('.b-product__qty').find(".js-qty-input").val(t).change()
    ...
    $(".rating").each(function(index,value)
    {
        ...
        mass.push($( value ).data('id'));

    });
    for(i = 0; i< mass.length; i++){
        var t = $('#raying-'+mass[i]).rateYo({
    ...
    function t() {
        ...
        a.top - i <= 0 ? a.top - i <= l ? (n.className = "stop", n.style.top = -l + "px") : (n.className = "sticky", n.style.top = (i + 100) + "px") : (n.className = "", n.style.top = ""), window.addEventListener("resize", function() {
...
}), /*$(".js-phone, #phone_callback, #phone").mask("+38999999999999", {
    placeholder: ""
}), */$(".js-phone, #phone_callback, #phone").mask("+3899999?9999999999", {
    placeholder: ""
}), $(document).ready(function() {
...
$('.cart-box').on('click', function(e){
    ...
    if($(window).width() < 1023) {
        document.location.href = 'http://3piroga.ua/backet';
    }
    const bas = $('.basket_info_all:hover').hasClass('basket_info_all')
    if(!bas){
        $('.basket_info_all').toggle()
    }

});

$('.basket_box, .cart-box').mouseout(function () {
    $('.basket_info_all').hide();
    $(".basket_info_all").removeAttr('style');
})

$('.sk_basket_show').mouseout(function(){
    $(".basket_info_all").removeAttr('style');
});

$('.nav_menu_bottom a').on('click', function(){
    const destination = $('#scroll-anchor').offset().top
    let delta = 0
    if($(window).width() < 1023) {
        delta = 105
    } else {
    ...
    console.log('POS: ', (parseFloat(destination) - parseFloat(delta)))
    $('html, body').animate({scrollTop: parseFloat(destination) - delta},500);
    // return false;
});
